...
update-stores-version:
	ls store/ | xargs -I % bash -c "sed -i '' -E 's,github.com/giovannicuriel/gocache/lib/v4 v[0-9]\.[0-9]\.[0-9],github.com/giovannicuriel/gocache/lib/v4 ${VERSION},g' store/%/go.mod"
